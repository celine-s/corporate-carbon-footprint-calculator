...
const categoryNavigation = [
  { name: 'Team', icon: UsersIcon }, ///rechner/[team]
...
export const Sidebar: FC<Props> = ({ children, question }) => {
  const [sidebarOpen, setSidebarOpen] = useState(false);
  const [categoryChangedManually, setCategoryChangedManually] = useState('Reisen');
  ...
  const allCategoriesAndFirstIndex = { Strom: '1', Heizung: '2', Transport: '3', Reisen: '5' };
  useEffect(() => {
    router.push(`/rechner/${allCategoriesAndFirstIndex.Strom}`);
  }, [categoryChangedManually]);
  console.log(categoryChangedManually);
  return (
    <>
      <div>
                    ...
                    {categoryNavigation.map((item) => (
                      <a
                        ...
                        onClick={() => {
                          ...
                          setCategoryChangedManually(item.name);
                        }}
                        className={
                  ...
                  <a href="#" className="flex-shrink-0 group block">
                    <div className="flex items-center">
                      ...
                      <div className="ml-3">
                        ...
                        <p className="text-sm font-medium text-gray-500 group-hover:text-gray-700">View report</p>
                      </div>
                    </div>
                  </a>
                </div>
          ...
          <div className="flex-1 flex flex-col min-h-0 border-r border-gray-200 bg-white">
            ...
            <div className="flex-shrink-0 flex border-t border-gray-200 p-4">
              <div className="flex-shrink-0 w-full group block">
                <LinkElement href="/rechner/saved">
                  <div className="ml-3 -mb-4">
                    <p className="text-sm font-medium text-gray-700 group-hover:text-gray-900 flex justify-start -mb-4">
                      Take a break?
                    </p>
                    <Copy>Save your answers here</Copy>
                  </div>
                </LinkElement>
              </div>
            </div>
